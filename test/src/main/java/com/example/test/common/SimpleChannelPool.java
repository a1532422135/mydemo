...
public class SimpleChannelPool implements ChannelPool {
    Logger logger = LoggerFactory.getLogger(SimpleChannelPool.class);
    ...
    private static final IllegalStateException FULL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new IllegalStateException("ChannelPool full"), io.netty.channel.pool.SimpleChannelPool.class, "releaseAndOffer(...)");
    ...
    protected Channel pollChannel() {
        logger.error("当前连接池连接个数为：{}",deque.size());
